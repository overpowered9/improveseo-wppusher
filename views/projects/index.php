    ...
    <div class="projectes improveseo_wrapper intro_page  p-3 p-lg-4">
        <section class="project-section border-bottom d-flex flex-row  justify-content-between align-items-center pb-2">
            <div class="project-heading d-flex flex-row">
                <img class="mr-2"
                     src="<?php echo esc_url(IMPROVESEO_WT_URL . '/assets/images/project-list-logo.png'); ?>"
                     alt="<?php esc_attr_e('ImproveSeo', 'improve-seo'); ?>">
                <h1><?php esc_html_e('Projects List', 'improve-seo'); ?></h1>
            </div>
            <div class="action-buttons">
                <a onclick="return confirm('<?php esc_attr_e('Are you sure you want to export all items?', 'improve-seo'); ?>');"
                   href="<?php echo esc_url(admin_url('admin.php?page=improveseo_projects&action=export_all_project&noheader=true')) ?>"
                   class="btn btn-outline-primary btn-small"
                   id="exportProject"><?php esc_html_e('Export All Project', 'improve-seo'); ?></a>
                <a href="#" class="btn btn-outline-primary btn-small"
                   id="importProject"><?php esc_html_e('Import', 'improve-seo'); ?></a>
                <a onclick="return confirm('<?php esc_attr_e('Please purchase the Pro version to access this feature and many more..', 'improve-seo'); ?>');"
                   href="javascript:void()" class="btn btn-outline-primary btn-small"
                   id="exportProject"><?php esc_html_e('Export All Project', 'improve-seo'); ?></a>
                <a href="javascript:void()" class="btn btn-outline-primary btn-small"
                   onclick="return confirm('<?php esc_attr_e('Please purchase the Pro version to access this feature and many more..', 'improve-seo'); ?>');"
                   id="importProject"><?php esc_html_e('Import', 'improve-seo'); ?></a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=improveseo_posting')) ?>"
                   class="btn btn-outline-primary btn-small"
                   id="btn-add"><?php esc_html_e('Add New', 'improve-seo'); ?></a>
            </div>
        </section>
        ...
        <section class="project-table-wrapper">
            <form method="get">
                ...
                <input type="hidden" name="is_preview_available" id="is_preview_available"
                       value="<?php echo esc_attr($is_preview); ?>"/>

                <div class="table-responsive-sm">
                    <div class="tablenav top">
                        <div class="alignleft actions bulkactions">
                            <label for="bulk-action-selector-top"
                                   class="screen-reader-text"><?php esc_html_e('Select bulk action', 'improve-seo'); ?></label>
                            <select name="action" id="bulk-action-selector-top">
                                <option value="bulk-empty"><?php esc_html_e('Bulk actions', 'improve-seo'); ?></option>
                                <option value="bulk-delete-all"
                                        class="hide-if-no-js"><?php esc_html_e('Delete project and all posts/pages', 'improve-seo'); ?></option>
                            ...
                            <input type="submit" id="doaction" class="del-btn btn btn-outline-danger button action"
                                   value="<?php esc_attr_e('Delete Projects', 'improve-seo'); ?>">
                        </div>
                    ...
                    <table class="table widefat fixed wp-list-table widefat fixed striped table-view-list posts">
                        ...
                        <tr>
                            <th scope="col" class="manage-column column-cb">
                                <label class="screen-reader-text"
                                       for="cb-select-all"><?php esc_html_e('Select All', 'your-text-domain'); ?></label>
                                <input id="cb-select-all" type="checkbox">
                            </th>
                            <th scope="col" class="manage-column column-title column-primary"
                                style="width: 26.66%"><?php esc_html_e('Name', 'your-text-domain'); ?></th>
                            <th scope="col"
                                class="manage-column"><?php esc_html_e('Created Posts', 'your-text-domain'); ?></th>
                            <th scope="col"
                                class="manage-column"><?php esc_html_e('Max Posts', 'your-text-domain'); ?></th>
                            <th scope="col"
                                class="manage-column"><?php esc_html_e('Created At', 'your-text-domain'); ?></th>
                            <th scope="col"
                                class="manage-column"><?php esc_html_e('Last Update', 'your-text-domain'); ?></th>
                            <th scope="col"
                                class="manage-column"><?php esc_html_e('Status', 'your-text-domain'); ?></th>
                        ...
                        <?php foreach ($projects as $project) : ?>
                            <tr <?php echo $highlight == $project->id ? ' class="WHProject--highlight"' : '' ?>>
                                <td><input id="cb-select-<?php echo esc_attr($project->id); ?>" type="checkbox"
                                           name="project_ids[]" value="<?php echo esc_attr($project->id); ?>"></td>
                                <td scope="col" class="column-title column-primary has-row-actions">
                                    <strong>
                                        <a href="javascript:void(0)"
                                           class="primary"><?php echo esc_attr($project->name) ?></a>
                                    </strong>
                                    <div class="row-actions">
										<span class="edit">
											<a class="ct-btn btn btn-outline-primary"
                                               href="<?php echo esc_url(admin_url("admin.php?page=improveseo_projects&action=export_urls&id={$project->id}&name={$project->name}&noheader=true")) ?>">
												<?php echo esc_html__('Export a list of all posts/pages URLs', 'your-text-domain') ?>
											</a>
										</span>
                                        <span class="edit">
											<a class="ct-btn btn btn-outline-primary"
                                               href="<?php echo esc_url(admin_url("admin.php?page=improveseo_dashboard&action=edit_post&id={$project->id}&update=true")) ?>">
												<?php echo esc_html__('Update posts', 'your-text-domain') ?>
											</a>
										</span>
                                        <span class="edit">
											<a class="ct-btn btn btn-outline-primary"
                                               href="<?php echo esc_url(admin_url('admin.php?page=improveseo_projects&action=duplicate&id=' . $project->id . '&noheader=true')) ?>">
												<?php echo esc_html__('Duplicate project', 'your-text-domain') ?>
											</a>
										</span>
                                        <span class="edit">
											<a class="ct-btn btn btn-outline-primary"
                                               href="<?php echo esc_url(admin_url('admin.php?page=improveseo_projects&action=stop&id=' . $project->id . '&noheader=true')) ?>">
												<?php echo esc_html__('Stop process', 'your-text-domain') ?>
											</a>
										</span>
                                        <span class="edit">
											<a class="ct-btn btn btn-outline-primary"
                                               onclick="return confirm('<?php echo esc_html__('Please purchase the Pro version to access this feature and many more..', 'your-text-domain') ?>');"
                                        ...
                                        <span class="trash">
											<a class="del-btn btn btn-outline-danger" class="submitdelete"
                                               ...
                                               onclick="return confirm('<?php echo esc_html__('This action will delete project and all generated posts/pages', 'your-text-domain') ?>')">
												<?php echo esc_html__('Delete project and all posts/pages', 'your-text-domain') ?>
											</a>
										</span>
                                        <span class="trash">
											<a class="del-btn btn btn-outline-danger" class="submitdelete"
                                               href="<?php echo esc_url(admin_url('admin.php?page=improveseo_projects&action=delete_posts&id=' . $project->id . '&noheader=true')) ?>"
                                               onclick="return confirm('<?php echo esc_html__('This action will delete all generated posts/pages', 'your-text-domain') ?>')">
												<?php echo esc_html__('Delete only posts/pages', 'your-text-domain') ?>
											</a>
										</span>
                                    </div>
                                    <button type="button" class="toggle-row"><span
                                                class="screen-reader-text"><?php echo esc_html__('Show more details', 'your-text-domain') ?></span>
                                    </button>
                                </td>

                                <td scope="col"
                                    data-colname="<?php esc_attr_e('Created Posts', 'improve-seo'); ?>"><?php echo esc_attr($project->iteration); ?></td>
                                <td scope="col"
                                    data-colname="<?php esc_attr_e('Max Posts', 'improve-seo'); ?>"><?php echo esc_attr($project->max_iterations); ?></td>
                                ...
                                <td scope="col" data-colname="<?php esc_attr_e('Actions', 'improve-seo'); ?>"
                                    class="actions-btn">
                                    <?php if ($project->state == 'Published' && $project->iteration < $project->max_iterations) : ?>
                                        <a href="#" class="btn btn-primary build-project"
                                    ...
                                    <?php if ($project->state == 'Updated' && $project->iteration < $project->max_iterations) : ?>
                                        <a href="javascript:update_project(<?php echo esc_attr($project->id); ?>)"
                                           class="btn btn-outline-primary" target="_self">
...
//                if ($project->state == 'Published' && $project->iteration < $project->max_iterations) {
//
//                    $inline_script = 'build_project(' . esc_attr($project->id) . ');';
//                    error_log("Inline Script: " . $inline_script);
//                    add_action('wp_enqueue_scripts', function () use ($inline_script){
//                        wp_enqueue_script('improveSeo-inline-script', esc_url(IMPROVESEO_DIR . '/assets/js/improveSeo-inline.js'), array(), '1.0');
//                        wp_add_inline_script('improveSeo-inline-script', $inline_script);
//                    });
//
//                    ?>
<!---->
...
//        }
        ...
        if (isset($_GET['build_posts_id'])) {
            ...
            $improve_seo_inline_script_2 = "update_project(" . esc_attr(sanitize_text_field($_GET['build_posts_id'])) . ")";
            add_action('wp_enqueue_scripts', function () {
                wp_enqueue_script('improveSeo-inline-script', esc_url(IMPROVESEO_DIR . '/assets/js/improveSeo-inline.js'), array(), '1.0');

                wp_add_inline_script('improveSeo-inline-script', $improve_seo_inline_script_2);
            });
            ?>
