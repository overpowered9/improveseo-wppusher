...
&raquo;
<span><?php esc_html_e('Create Shortcode', 'improve-seo'); ?></span>
<?php View::endSection('breadcrumbs') ?>
<?php View::startSection('content') ?>
<h1 class="hidden"><?php esc_html_e('Create Shortcode', 'improve-seo'); ?></h1>
<div class="shortcode improveseo_wrapper p-3 p-lg-4">
    <section class="project-section">
        <div class="project-heading d-flex flex-row align-items-center border-bottom pb-2">
            ...
            <h1><?php esc_html_e('Create Shortcode', 'improve-seo'); ?></h1>
        </div>
    ...
    <section class="form-wrap">
        <form action="<?php echo esc_url(admin_url('admin.php?page=improveseo_shortcodes&action=do_create&noheader=true')); ?>" method="post">
            <?php View::render('shortcodes.form'); ?>
            <div class="Posting__buttons shortcode-form-btn my-0 text-center">
                <button class="btn btn-outline-primary"><?php esc_html_e('Create Now', 'improve-seo'); ?></button>
            </div>
        </form>
    </section>
</div>
