						...
						<tr>
							<td class="column-title column-primary has-row-actions">
								...
								<div class="row-actions">
									<span class="edit">
										<a href="<?php echo esc_url( admin_url('admin.php?page=improveseo_shortcodes&action=edit&id='. $code->id) ); ?>" title="Edit this item">Edit</a>
										|
									</span>
									<span class="trash">
										<a class="submitdelete" href="<?php echo esc_url( admin_url('admin.php?page=improveseo_shortcodes&action=delete&id='. $code->id .'&noheader=true') ); ?>">Trash</a>
									</span>
								</div>
