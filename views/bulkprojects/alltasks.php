	...
	<form method="get">
		...
		<div class="actions">
			...
			<input type="hidden" value="bulk-delete-posts" name="action">
				<button type="submit" id="doaction" class="btn_delete action" value="Delete Projects">Delete Selected Projects</button>
					...
					<tbody>
						<?php foreach ($projects as $key => $project): ?>
							...
							<tr <?= $highlight == $project->id ? ' class="WHProject--highlight"' : '' ?>>
								<td data-label="Name">
									<label class="checkbox style-c">
									<input id="cb-select-<?php echo $project->id; ?>" type="checkbox" name="project_ids[]" value="<?php echo $project->id; ?>">
										<div class="checkbox__checkmark"></div>
									</label>
...
<!-- 
												...
												<?php if (!empty($project->post_id)) { ?>
													...
													<span class="primary">
														<a class="popup-link" class="submitdelete"
															target="_blank" href="<?php echo $preview_link; ?>">View AI
															content</a>
													</span>
												<?php } else { ?>
													<span class="primary">
												...
												<?php if (!empty($project->post_id)) {
													...
													<span class="primary">
														<a class="popup-link" class="submitdelete"
															target="_blank" href="<?php echo $edit_link; ?>"
