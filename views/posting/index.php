		...
		<div class="create-ai-post">
			<div class="create-ai">
				...
				<div class="create-ai-col"<?php if ( $from_onboarding ) { echo ' style="opacity:0.4;pointer-events:none;"'; } ?>>
					...
					<h3>
						<a class="Posting__page-button" href="<?php echo admin_url("admin.php?page=improveseo_posting&action=create_post_bulk"); ?>" aria-describedby="iseo-tip-bulk-post">Create Bulk AI Posts Project</a>
						<span class="create-ai-tip">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
							<span class="create-ai-tip-bubble is-wide is-interactive" id="iseo-tip-bulk-post" role="tooltip">Create a project with multiple posts based on a keyword list. Don&rsquo;t have a keyword list? <a href="<?php echo admin_url( 'admin.php?page=improveseo_lists' ); ?>">Create one</a> before you get started.</span>
						</span>
					</h3>
				</div>
			</div>
