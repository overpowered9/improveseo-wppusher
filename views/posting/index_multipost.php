		...
		<div class="create-ai-post">
			<div class="create-ai">
				...
				<div class="create-ai-col">
					...
					<h3>
						<a class="Posting__page-button" href="<?php echo admin_url("admin.php?page=improveseo_posting&action=create_post_bulk"); ?>" aria-describedby="iseo-tip-bulk-post">Bulk Create AI Posts</a>
