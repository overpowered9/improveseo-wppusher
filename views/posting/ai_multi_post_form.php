...
<div class="modal fade" id="exampleModalBulk" tabindex="-1" role="dialog" aria-labelledby="exampleModalBulkLabel" aria-hidden="true">
			...
			<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
			   ...
			   <div class="modal-content">
				   ...
				   <div class="modal-header">
					   ...
					   <h5 class="modal-title" id="exampleModalBulkLabel">Generate Bulk AI Posts</h5>
