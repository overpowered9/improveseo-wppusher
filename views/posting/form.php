						...
						<div id="google-preview" class="google-preview">
							...
							<div class="input-group" style="padding-top: 30px;">
								...
								<div class="input-prefix">
									<input id="custom-title" name="custom_title" class="form-control" type="text" style="padding: 20px; border-radius: 10px !important; border-color: #cccccc; margin-bottom: 20px; "
										class="full-width form-control textarea-control" placeholder="Meta Title:Here Ex:Mango: Health Benefits"
							...
							<div class="input-group">
								...
								<!-- <div class="input-prefix"> -->
									<textarea id="custom-description" placeholder="Meta Description:Discover Mango Magic: Health Benefits, Recipes, and Tips for the Perfect Fruit."
						...
						<div class="inside">
							<div class="customizer-wrapper seo-post-meta-wrapper">
								...
								<div class="input-group my-4 cta-check">
									<span>
										<input id="on-page-seo" name="on_page_seo" type="checkbox" value="1"
											<?= $old_on_page_seo == 1 ? ' checked' : '' ?>>
										<label for="on-page-seo">Enable Improve SEO On-Page Customizer</label>
									</span>
								</div>
								<div id="on-page-seo-wrap"
									style="display: <?= $old_on_page_seo == 1 ? 'block' : 'none' ?>;">
									...
									<div class="input-group">
										...
										<div class="input-prefix">
											<input id="custom-title" name="custom_title" class="form-control"
												type="text" class="full-width form-control textarea-control"
												placeholder="Title"
												value="<?= Validator::old('custom_title', $task->options['custom_title']) ?>">
											<span>Ex.</span>
										</div>
									...
									<div class="input-group">
										...
										<div class="input-prefix">
											<textarea id="custom-keywords" placeholder="Keywords" name="custom_keywords"
												class="full-width textarea-control"><?= Validator::old('custom_keywords', $task->options['custom_keywords']) ?></textarea>
											<span>Ex.</span>
										</div>
									</div>
								</div>
							...
							<div class="seo-post-meta-wrapper feature-wrapper">
								<div class="input-group my-4 cta-check">
									<span>
										<input id="local-seo-enabler" name="local_seo_enabler" type="checkbox" value="1"
											<?= $old_local_seo_enabler == 1 ? 'checked' : ''; ?>>
										<label for="local-seo-enabler">Enable Improve SEO Local SEO Feature</label>
									</span>
								</div>
								<div id="local-seo-wrap"
									style="display: <?= $old_local_seo_enabler == 1 ? 'block' : 'none'; ?>;">
									<div class="input-group cta-check">
										<span>
											<input id="local-randomize" name="local_randomize" type="checkbox" value="1"
												<?= Validator::old('local_randomize', $task->options['local_randomize']) == 1 ? 'checked' : '' ?>>
							...
							<div class="seo-post-meta-wrapper schema-wrapper">
								...
								<div id="schema-wrap" style="display: <?= $old_schema == 1 ? 'block' : 'none' ?>;">
									<div class="input-group my-4 cta-check">
										<span>
											<input type="checkbox" name="hide_schema" id="hide-schema" value="1"
												<?= Validator::old('hide_schema', $task->options['hide_schema']) ? 'checked' : '' ?>>
									...
									<div class="input-group">
										...
										<div class="input-prefix">
											<input id="schema-business" placeholder="Business Name"
												name="schema_business" type="text" class="full-width form-control"
												value="<?= Validator::old('schema_business', $task->options['schema_business']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<textarea id="schema-description" placeholder="Description"
												name="schema_description"
												class="full-width textarea-control"><?= Validator::old('schema_description', $task->options['schema_description']) ?></textarea>
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<input type="text" id="schema-email" placeholder="E-mail"
												name="schema_email" class="full-width form-control"
												value="<?= Validator::old('schema_email', $task->options['schema_email']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<input type="tel" id="schema-telephone" placeholder="Telephone"
												name="schema_telephone" class="full-width form-control"
												value="<?= Validator::old('schema_telephone', $task->options['schema_telephone']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									...
									<div class="input-group">
										...
										<div class="input-prefix">
											<textarea id="schema-social" placeholder="Social pages" name="schema_social"
												class="full-width textarea-control"><?= Validator::old('schema_social', $task->options['schema_social']) ?></textarea>
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<input id="schema-rating-object" placeholder="Rating Object"
												name="schema_rating_object" type="text" class="full-width form-control"
												value="<?= Validator::old('schema_rating_object', $task->options['schema_rating_object']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<input id="schema-rating" placeholder="Rating" name="schema_rating"
												type="text" class="full-width form-control"
												value="<?= Validator::old('schema_rating', $task->options['schema_rating']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<input id="schema-rating-count" placeholder="Rating Count"
												name="schema_rating_count" type="text" class="full-width form-control"
												value="<?= Validator::old('schema_rating_count', $task->options['schema_rating_count']) ?>">
											<span>Ex.</span>
										</div>
									</div>
									<div class="input-group">
										...
										<div class="input-prefix">
											<textarea id="schema-address" placeholder="Address" name="schema_address"
												class="full-width textarea-control"><?= Validator::old('schema_address', $task->options['schema_address']) ?></textarea>
											<span>Ex.</span>
										</div>
									</div>
								</div>
