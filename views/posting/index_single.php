		...
		<div class="create-ai-post">
			<div class="create-ai">
				...
				<div class="create-ai-col">
					<a class="Posting__post-button" href="<?php echo esc_url( admin_url("admin.php?page=improveseo_posting&action=create_post_single") ); ?>" aria-describedby="iseo-tip-single-post">
