										...
										<div class="form-group col-md-1"></div>
											<div class="form-group col-md-5">
												<div class="form-check-inline">
													<input type="button" id="single_post_btn" class="form-check-input" value="Create Single Post" checked>
												</div>
											</div>
											<div class="form-group col-md-1"></div>
											<div class="form-group col-md-5">
												<div class="form-check-inline">
													<input type="button" id="multi_post_btn" class="form-check-input" value="Create Multiple Post">
												</div>
											</div>
                                   </div>
   ...
   <label>Generate AI Image Based On Title</label> 
   									...
   									<div class="col-md-6" style="text-align: left;margin-top: 30px;">
   										<input type="radio" name="aiImage" value="Manually_image" onclick="ManuallyImages();" id="Manually_image">
