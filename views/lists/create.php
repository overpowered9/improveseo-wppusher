...
&raquo;
<span><?php esc_html_e('Create New List', 'improve-seo'); ?></span>
<?php View::endSection('breadcrumbs') ?>

<?php View::startSection('content') ?>
<h1 class="hidden"><?php esc_html_e('Create New List', 'improve-seo'); ?></h1>
<div class="listing improveseo_wrapper p-3 p-lg-4">
	<section class="project-section">
		<div class="project-heading d-flex flex-row align-items-center border-bottom pb-2">
			...
			<h1><?php esc_html_e('Create New List', 'improve-seo'); ?></h1>
		</div>
