	...
	<div class="setting-seo-tab">
		...
		<div class="setting-seo-tab-header">
			<div class="setting-seo-tabs">
				<button
					class="setting-seo-tab-btn <?php echo esc_attr( ($action != "googlemaps" && $action != "buttons" && $action != "videos" && $action != "testimonial") ? 'active' : '' ); ?>"
				...
				<button class="setting-seo-tab-btn <?php echo esc_attr( ($action == "testimonial") ? 'active' : '' ); ?> "
				...
				<button class="setting-seo-tab-btn  <?php echo esc_attr( ($action == "googlemaps") ? 'active' : '' ); ?> "
				...
				<button class="setting-seo-tab-btn  <?php echo esc_attr( ($action == "buttons") ? 'active' : '' ); ?> "
				...
				<button class="setting-seo-tab-btn <?php echo esc_attr( ($action == "videos") ? 'active' : '' ); ?>"
		...
		<div id="setting-seo-testimonials"
			class="setting-seo-tab-content <?php echo esc_attr( ($action == "testimonial") ? 'show active' : '' ); ?>"
					...
					<form class="improve-seo-form-global wt-save-admin-settings-testimonials">
						...
						<div class="seo-form-field">
							...
							<input type="text" name="tw_testi_shortcode_name" id="testimonialName"
								placeholder="Ex. Test 1" value="<?php echo esc_attr( $tw_testi_shortcode_name ); ?>">
						</div>
						<div class="seo-form-field">
							...
							style=" border-radius: 11px; height: 85px;" rows="1" value="<?php echo esc_attr( $tw_testi_content ); ?>"><?php echo esc_textarea( $tw_testi_content ); ?></textarea>
							<!-- <input type="text" id="testimonialContent" name="tw_testi_content" placeholder="Ex. Test"
								style=" border-radius: 11px;" value="<?php echo esc_attr( $tw_testi_content ); ?>"></input> -->
						</div>
						<div class="setting-tab-colss-col">
							<div class="seo-form-field">
								<label for="clientName">Client Name</label>
								<input type="text" name="tw_testi_name" value="<?php echo esc_attr( $tw_testi_name ); ?>"
									id="clientName" placeholder="Ex. Anil">
							</div>
							<div class="seo-form-field">
								<label for="clientPosition">Client Position</label>
								<input type="text" name="tw_testi_position"
									value="<?php echo esc_attr( stripslashes($tw_testi_position) ); ?>" id="clientPosition"
									placeholder="Ex. CEO">
							</div>
						</div>
							...
							<div>
								...
								<div class="seo-color-picker">
									...
									<input type="color" id="boxColorPicker" onchange="updateColor('boxColor', this)"
										name="tw_box_color" value="<?php echo esc_attr( $tw_box_color ); ?>">
							...
							<div>
								...
								<div class="seo-color-picker">
									...
									<input type="color" id="fontColorPicker" onchange="updateColor('fontColor', this)"
										name="tw_font_color" value="<?php echo esc_attr( $tw_font_color ); ?>">
							...
							<div>
								...
								<div class="seo-color-picker">
									...
									<input type="color" id="outlineColorPicker"
										...
										value="<?php echo esc_attr( $tw_testi_outline_color ); ?>">
		...
		<div id="setting-seo-maps"
			class="setting-seo-tab-content <?php echo esc_attr( ($action == "googlemaps") ? 'show active' : '' ); ?>"
			...
			<form class="wt-save-admin-settings-googlemaps improve-seo-form-global">
				<div class="seo-form-field">
					...
					<input type="text" name="tw_maps_shortcode_name" placeholder="Ex. Map 1"
						value="<?php echo esc_attr( $tw_maps_shortcode_name ); ?>">
				</div>
				<div class="seo-form-field">
					...
					<input type="hidden" class="updateingdata" name="updateandedit_data" value="<?php echo esc_attr( $no ); ?>">
					<input type="text" name="tw_maps_apikey" placeholder="" value="<?php echo esc_attr( $tw_maps_apikey ); ?>">
				</div>
				<div class="seo-form-field">
		...
		<div id="setting-seo-button"
			class="setting-seo-tab-content <?php echo esc_attr( ($action == "buttons") ? 'show active' : '' ); ?>" id="button_wt"
					...
					<form class="wt-save-admin-settings-buttons improve-seo-form-global">
						...
						<div class="seo-form-field">
							...
							<input type="text" placeholder="Ex. Button 1" name="tw_button_shortcode_name"
								value="<?php echo esc_attr( $tw_button_shortcode_name ); ?>" />
						</div>
						<div class="seo-form-field">
							<div class="setting-toggle-group">
								...
								<div class="setting-toggle-container">
									...
									<input class="form-check-input tw_button_type" type="radio" name="tw_button_type"
										id="tw_button_type_normal" value="normal_btn" <?php checked('normal_btn', $tw_button_type); ?> />

									<label for="tw_button_type_tap_to_call" class="setting-toggle toggle_Tap_to_call"
										onclick="toggle(this)">Tap to call</label>

									<input class="form-check-input tw_button_type" type="radio" name="tw_button_type"
										id="tw_button_type_tap_to_call" value="tap_to_call" <?php checked('tap_to_call', $tw_button_type); ?> />
										...
										<button  class="styling_post_page_action_buttons  tap-to-call-upload-image-js upload-btn-padding">
											...
											if ($tw_tap_to_call_img_source != ""): ?>
												<img class="tap-to-call-img" style="width: 62px;"
													src="<?php echo esc_url( $tw_tap_to_call_img_source ); ?>" />
											<?php endif; ?>
										</button>
									</div>
										...
										<div class="input-group" style="margin-top: 10px;">
											...
											<div class="input-prefix">
												<input  style="margin-top: 10px;" type="text" class="form-control name" placeholder="Ex. Next"
													name="tw_tap_btn_text" value="<?php echo esc_attr( $tw_tap_btn_text ); ?>">
										...
										<div class="input-group" style="margin-top: 10px;">
											...
											<div class="input-prefix">
												<input  style="margin-top: 10px;" type="text" class="form-control name"
													...
													value="<?php echo esc_attr( $tw_tap_btn_number ); ?>" />
						...
						<div class="setting-toggle-group">
							...
							<div class="setting-toggle-container">
								...
								<input class="form-check-input" type="radio" name="tw_button_border_type"
									id="tw_button_border_type_square" value="square" <?php checked('square', $tw_button_border_type); ?> />
								<label for="tw_button_border_type_round"
									class="setting-toggle toggle_border_type__round" onclick="toggle(this)">Round
									corners</label>
								<input class="form-check-input" type="radio" name="tw_button_border_type"
									id="tw_button_border_type_round" value="round" <?php checked('round', $tw_button_border_type); ?> />
							</div>
						</div>
						<div class="seo-form-field">
		...
		<div id="setting-seo-videos"
			class="setting-seo-tab-content <?php echo esc_attr( ($action == "videos") ? 'show active' : '' ); ?>" id="videos"
					...
					<form class="wt-save-admin-settings-videos improve-seo-form-global">
						...
						<div class="seo-form-field">
							...
							<input type="text" name="video_shortcode_name" class="form-control name"
								value="<?php echo esc_attr( $video_shortcode_name ); ?>" placeholder="Shortcode Name" />
						</div>
						<div class="seo-form-field">
						...
						<div class="seo-form-field upload_video_wrapper" style="margin-bottom: 40px;"
							style="<?php echo esc_attr( ($video_type != 'upload_video') ? 'display:none' : '' ); ?>">
							...
							<input type="hidden" class="form-control video-id-mp4" name="video_id_mp4"
								value="<?php echo esc_attr( $video_id_mp4 ); ?>" readonly/>
							<input type="text" placeholder="Video MP4 Link" class="form-control video-url-mp4"
								name="video_url_mp4" value="<?php echo esc_attr( $video_url_mp4 ); ?>" readonly />
						</div>
						</div>
						<div class="row">
							<div class="col-12 youtube_wrapper"
								style="<?php echo esc_attr( ($video_type != 'youtube') ? 'display:none' : '' ); ?>">
								<div class="row">
									<div class=" col-lg">
										<div class="input-group">
											...
											<input type="text" class="form-control video-url-youtube"
												...
												value="<?php echo esc_attr( $video_url_youtube ); ?>" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-12 vimeo_wrapper"
								style="<?php echo esc_attr( ($video_type != 'vimeo') ? 'display:none' : '' ); ?>">
								<div class="row">
									<div class="col-lg">
										<div class="input-group">
											...
											<input type="text" class="form-control video-url-vimeo"
												name="video_url_vimeo" value="<?php echo esc_attr( $video_url_vimeo ); ?>" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="setting-tab-colss-col">
							<div class="seo-form-field">
								...
								<input type="number" class="name" placeholder="800" name="video_width"
									value="<?php echo esc_attr( $video_width ); ?>" min="1" max="1920" />
							</div>
							...
							<div class="seo-form-field">
								...
								<input type="number" class="name" placeholder="800" name="video_height"
									value="<?php echo esc_attr( $video_height ); ?>" min="1" max="700" />
							</div>
						</div>
						...
						<div class="setting-toggle-group">
							...
							<div class="setting-toggle-container">
								<input class="form-check-input video_autoplay" type="radio" name="video_autoplay"
									id="video_autoplay_yes" value="yes" <?php checked('yes', $video_autoplay); ?> />
								<label for="video_autoplay_yes" class="setting-toggle toggle_video_autoplay_yes"
									onclick="toggle(this)">Yes</label>
								<input class="form-check-input video_autoplay" type="radio" name="video_autoplay"
									id="video_autoplay_no" value="no" <?php checked('no', $video_autoplay); ?> />
						...
						<div class="setting-toggle-group">
							...
							<div class="setting-toggle-container">
								...
								<input class="form-check-input video_muted" type="radio" name="video_muted"
									id="video_muted_yes" value="yes" <?php checked('yes', $video_muted); ?> />
								<label for="video_muted_no" class="setting-toggle toggle_video_muted_no"
									onclick="toggle(this)">No</label>
								<input class="form-check-input video_muted" type="radio" name="video_muted"
									id="video_muted_no" value="no" <?php checked('no', $video_muted); ?> />
							</div>
						</div>
						<div class="setting-toggle-group">
							...
							<div class="setting-toggle-container">
								...
								<input class="form-check-input video_controls" type="radio" name="video_controls"
									id="video_controls_yes" value="yes" <?php checked('yes', $video_controls); ?> />
								<label for="video_controls_no" class="setting-toggle toggle_video_controls_no"
									onclick="toggle(this)">No</label>
								<input class="form-check-input video_controls" type="radio" name="video_controls"
									id="video_controls_no" value="no" <?php checked('no', $video_controls); ?> />
							</div>
						</div>
						<div class="setting-toggle-group">
							...
							<div class="setting-toggle-container">
								...
								<input class="form-check-input video_loop" type="radio" name="video_loop"
									id="video_loop_yes" value="yes" <?php checked('yes', $video_loop); ?> />
								<label for="video_loop_no" class="setting-toggle toggle_video_loop_no" onclick="toggle(this)">No</label>
								<input class="form-check-input video_loop" type="radio" name="video_loop"
									id="video_loop_no" value="no" <?php checked('no', $video_loop); ?> />
							</div>
						</div>
						<div class="seo-form-field">
...
<div id="setting-seo-shortcodes"
	class="setting-seo-tab-content  <?php echo esc_attr( ($action != "googlemaps" && $action != "buttons" && $action != "videos" && $action != "testimonial") ? 'show active' : '' ); ?>"
