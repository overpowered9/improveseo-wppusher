                ...
                <tbody>
                    ...
                    if (!empty($ids)) {
                        foreach ($ids as $id) {
                            ...
                            $html .= '<td data-label="Google Maps APIKEY">' . $tw_maps_apikey . '</td>';
                            $html .= '<td class="actions-btn" data-label="Actions">
                        <div style="
    display: flex;
    justify-content: space-evenly;
                ...
                <tbody>
                    ...
                    if (!empty($ids)) {
                        foreach ($ids as $id) {
                            ...
                            $html .= '<td data-label="Auto play"  class="status paused" ><div class="style_video_controller"><div class="' . (strtolower($video_autoplay) === 'yes' ? 'yes-btn-td' : '') . '"> ' . ucfirst($video_autoplay) . ' </div></div></td>';
                            $html .= '<td data-label="Mute"  class="status paused"><div class="style_video_controller"><div class="' . (strtolower($video_muted) === 'yes' ? 'yes-btn-td' : '') . '">' . ucfirst($video_muted) . '</div></div></td>';
                            $html .= '<td data-label="Controls"   class="status paused"><div class="style_video_controller"><div class="' . (strtolower($video_controls) === 'yes' ? 'yes-btn-td' : '') . '"> ' . ucfirst($video_controls) . '</div></div> </td>';
                            $html .= '<td data-label="Loop"  class="status paused"><div class="style_video_controller"><div class="' . (strtolower($video_loop) === 'yes' ? 'yes-btn-td' : '') . '">  ' . ucfirst($video_loop) . '</div></div></td>';
