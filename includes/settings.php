...
function improveseo_init_settings() {
	...
	register_setting('improveseo_settings', 'improveseo_api_key',   array( 'sanitize_callback' => 'sanitize_text_field' ));
	register_setting('improveseo_settings', 'improveseo_site_code', array( 'sanitize_callback' => 'sanitize_text_field' ));
