...
<?php
      ...
      $apiUrl = 'https://api.openai.com/v1/chat/completions';
   	...
   	if($content_type!='') {
          ...
          if ($seed_type=='seed_option2')
          {
   		...
   		$question = 'Create a compelling seo optimized blog post title based on the keyword `'.$seed_keyword.'` do not include emojis or hashtags. Limit characters not including spaces to 80-100.'.$content_type;
   ...
   // create LSI keywords
   $text_for_lsi = 'You assume that you are an SEO manager. Create a list of 50 LSI keywords that are related to the keyword '.$seed_keyword.' Give me only keywords without any explanation';
   // Your chat messages
   $messages = [
   	// ['role' => 'system', 'content' => 'You are a helpful assistant.'],
