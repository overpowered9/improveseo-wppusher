...
function improveseo_enqueue_admin(){
	...
	wp_enqueue_style('improveseo-main', esc_url(IMPROVESEO_DIR . '/assets/css/main.css'), array('wp-admin'));

	wp_enqueue_style('improveseo-tree', esc_url(IMPROVESEO_DIR . '/assets/css/tree.min.css'));
	wp_enqueue_style('improveseo-fa', esc_url(IMPROVESEO_DIR.'/assets/css/font-awesome.min.css'));
	wp_enqueue_style('improveseo-modalStyle',esc_url(IMPROVESEO_DIR . '/assets/js/jquery.modal.min.css'));

	//wp_enqueue_script('improveseo-bootstrap', IMPROVESEO_DIR . '/assets/js/bootstrap.min.js', array('jquery'), IMPROVESEO_VERSION, true);
	wp_enqueue_script('improveseo-main', esc_url(IMPROVESEO_DIR . '/assets/js/main.js'), array('jquery'), IMPROVESEO_VERSION, true);
...
function improveseo_enqueue_front(){
	wp_enqueue_style('improveseo-front', esc_url(IMPROVESEO_DIR . '/assets/css/improveseo-front.css'), array(), '2.0');
}